...
$ajaxAction = isset($_REQUEST['action'])?$_REQUEST['action']:'';
define("AJAX_ACTION",$ajaxAction);
...
register_activation_hook(__FILE__, 'plugin_activation_createtable');
register_deactivation_hook(__FILE__, 'plugin_activation_deletetable');
